...
const Register = (props: MyProps) => {
    ...
    const emailValidator = (rule: Rule, value: string, callback: (message?: string) => void) => {
        if (!value) {
    ...
    const passwordValidator = (rule: Rule, value: string, callback: (message?: string) => void) => {
        if (!value) {
            ...
            >
                ...
                >
                    ...
                    <Form.Item className='form-submit'>
                        <motion.div
                            style={{ cursor: 'pointer', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}
